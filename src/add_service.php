...
<body class="bg-orange-100 h-screen flex flex-col md:flex-row">
    ...
    <main class="flex-1 p-6 md:ml-0">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <h2 class="text-orange-700 font-semibold mb-4">All Services</h2>
    ...
    <h2 class="text-2xl font-bold text-center text-orange-700 mt-2 mb-6 w-full">
        ...
        <div class="mb-4">
          ...
          <select id="company" name="company" required class="w-full border text-black border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500">
        ...
        >
          + Add New Service
                ...
                <button id="add-category-btn" class="bg-orange-600 mb-2 hover:bg-orange-500 text-white px-4 py-2 rounded">Add New Service</button>
    ...
    <script>
        ...
        const serviceDropdown = document.getElementById('company');
        ...
        .then(data => {
          serviceDropdown.innerHTML = data || '<option value="">No companies found</option>';
        })
        .catch(error => {
          serviceDropdown.innerHTML = '<option value="">Error loading companies</option>';
