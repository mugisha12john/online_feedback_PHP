...
<html lang="en">
  ...
  >
    <div class="bg-white shadow-lg rounded-2xl w-full max-w-md p-8 relative">
      ...
      <hr class="my-6 border-1 border-orange-600" />
      <a href="login_admin.php">
                <button
          type="submit"
          class="w-full border-2 border-orange-600 text-orange-600 hover:text-white py-2 rounded-lg font-semibold hover:bg-orange-700 transition"
        >
          Login as Admin
        </button>
      </a>
      <p class="text-center text-gray-600 text-sm mt-4">
        ...
        <a href="signup.php" class="text-orange-600 font-medium hover:underline">
          Sign in
        </a>
      </p>
      <p class="text-center text-gray-600 text-sm mt-4">
